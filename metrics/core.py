...
from metrics.processors.common import get_metric_modules
from omegaconf import OmegaConf

from .utilites import update_status, get_image_paths, set_global_result_path
...
def run():
    ...
    for metric in get_metric_modules(metrics.globals.processors):
        if not metric.pre_start():
            return
    result_path = set_global_result_path()
